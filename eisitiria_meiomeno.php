...
$code = $_POST['code'];
$result = mysqli_query($db,"SELECT * FROM `eisitiria_meiomeno` WHERE `code`='$code'");
...
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="css/eisitiria_meiomeno.css">
<!--===============================================================================================-->
</head>
<body class="animsition">
		...
		<div class="container-login100">
			...
			<div class="container-login100-form-btn3">Μειωμένο 90 λεπτών <p class="txt7"> 0,60€</p></div>					
			...
			<div class="container-login100-form-btn6">Μειωμένο </br> λεωφορείων <p class="txt7">EXPRESS 3,00€</p></div>					
			<div class="container-login100-form-btn7">Μειωμένο ΜΕΤΡΟ<p class="txt7"> 5,00€</p></div>		
			<div class="container-login100-form-btn8">Αεροδρομίου μετ' επιστροφής ΜΕΤΡΟ <p class="txt7"> 18,00€</p></div>
			<div class="container-login100-form-btn9">Αεροδρομίου από και  <p class="txt7"> προς Παλλήνη-Κάντζα-<p class="txt7">Κορωπί ΜΕΤΡΟ  3,00€</p></div>	
		...
		$result = mysqli_query($db,"SELECT * FROM `eisitiria_meiomeno`");
